...
def load_network(arch_file_path, weights_file_path):
    assert os.path.exists(arch_file_path), "{} does not exist, or is not a file".format(arch_file_path)
    assert os.path.exists(weights_file_path), "{} does not exist, or is not a file".format(weights_file_path)
